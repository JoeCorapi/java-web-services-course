...
public interface CustomerOrdersPortType {
    ...
    @WebMethod
    @WebResult(name = "deleteOrdersResponse", targetNamespace = "http://trainings.ws.bharath.com/", partName = "parameters")
    public DeleteOrdersResponse deleteOrders(
        @WebParam(partName = "parameters", name = "deleteOrdersRequest", targetNamespace = "http://trainings.ws.bharath.com/")
